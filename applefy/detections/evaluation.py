...
def estimate_stellar_flux(psf_template,
                          dit_science,
                          dit_psf_template,
...
def _compute_throughput_fixed_contrast(fake_planet_results,
                                       fp_residual,
                                       stellar_flux,
                                       inserted_flux_ratio,
                                       photometry_mode: AperturePhotometryMode):
...
def compute_throughput_table(planet_dict,
                             fp_residual,
                             idx_table,
                             stellar_flux,
...
def merge_residual_stack(planet_dict,
                         idx_table):
    """
...
def compute_contrast_curve(throughput_list: pd.DataFrame,
                           stellar_flux,
                           fp_residual,
...
def compute_detection_confidence(frame,
                                 planet_position,
                                 test_statistic: TestInterface,
                                 psf_fwhm_radius,
                                 photometry_mode_planet: AperturePhotometryMode,
...
def compute_contrast_from_map(contrast_map_fpf,
                              fpf_threshold):
    """
